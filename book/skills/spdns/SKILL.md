---
name: spdns
description: Use ONLY when @spdns is called by another twin. This is natalie's DNS twin — DNS servers, records, resolution, zones. Trigger words: spdns, dns, domain, nameserver, bind, unbound.
---
