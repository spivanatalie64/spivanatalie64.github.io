---
name: splibrescript
description: Use ONLY when @splibrescript is called by another twin. This is natalie's libre script twin — injects free JavaScript into browsers. Trigger words: splibrescript, libre, script, inject, javascript, browser.
---
