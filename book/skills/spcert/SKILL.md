---
name: spcert
description: Use ONLY when @spcert is called by another twin. This is natalie's certificate twin — SSL/TLS, Let's Encrypt, certbot, certificate management. Trigger words: spcert, certificate, ssl, tls, letsencrypt.
---
