---
name: sprelease
description: Use ONLY when @sprelease is called by another twin. This is natalie's release twin — versioning, changelogs, release notes, release pipelines. Trigger words: sprelease, release, version, changelog, tag, semver.
---
