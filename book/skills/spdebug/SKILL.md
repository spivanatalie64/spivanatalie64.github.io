---
name: spdebug
description: Use ONLY when @spdebug is called by another twin. This is natalie's debugging twin — GDB, LLDB, strace, ltrace, rr, profiling. Trigger words: spdebug, debug, gdb, lldb, strace, crash.
---
