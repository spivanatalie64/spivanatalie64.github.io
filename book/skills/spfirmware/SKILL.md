---
name: spfirmware
description: Use ONLY when @spfirmware is called by another twin. This is natalie's firmware twin — embedded systems, microcontrollers, firmware dev. Trigger words: spfirmware, firmware, embedded, microcontroller, mcu.
---
