---
name: spwebhook
description: Use ONLY when @spwebhook is called by another twin. This is natalie's webhook twin — webhook management, integration, automation triggers. Trigger words: spwebhook, webhook, hook, trigger, integration, automations.
---
