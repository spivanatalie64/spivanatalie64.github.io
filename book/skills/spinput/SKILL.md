---
name: spinput
description: Use ONLY when @spinput is called by another twin. This is natalie's input devices twin — keyboards, mice, touchpads, gamepads, config. Trigger words: spinput, input, keyboard, mouse, touchpad, gamepad.
---
