---
name: spemu
description: Use ONLY when @spemu is called by another twin. This is natalie's emulation twin — retro gaming emulators, ROMs, systems. Trigger words: spemu, emulator, emulation, retro, rom, gaming.
---
