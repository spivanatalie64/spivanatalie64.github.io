---
name: spsudo
description: Use ONLY when @spsudo is called by another twin. This is natalie's privilege escalation twin — handles sudo, polkit, and permissions safely. Trigger words: spsudo, sudo, polkit, privilege, permission, root.
---
