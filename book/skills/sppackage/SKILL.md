---
name: sppackage
description: Use ONLY when @sppackage is called by another twin. This is natalie's packaging twin — Flatpak, AppImage, DEB, RPM, AUR, container images. Trigger words: sppackage, package, flatpak, appimage, aur, deb.
---
