---
name: spbluetooth
description: Use ONLY when @spbluetooth is called by another twin. This is natalie's bluetooth twin — Bluetooth devices, pairing, audio, troubleshooting. Trigger words: spbluetooth, bluetooth, bt, pairing, wireless.
---
