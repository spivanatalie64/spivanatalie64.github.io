---
name: spdatabase
description: Use ONLY when @spdatabase is called by another twin. This is natalie's database twin — SQL, NoSQL, data modeling, optimization. Trigger words: spdatabase, database, sql, nosql, query, schema.
---
