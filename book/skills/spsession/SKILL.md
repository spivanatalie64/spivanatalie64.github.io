---
name: spsession
description: Use ONLY when @spsession is called by another twin. This is natalie's session manager twin — handles login, logout, power management. Trigger words: spsession, session, login, logout, sddm, greetd.
---
