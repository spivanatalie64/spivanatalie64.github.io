---
name: spwrite
description: Use ONLY when @spwrite is called by another twin. This is natalie's writing twin — blog posts, articles, technical writing, copy. Trigger words: spwrite, write, writing, blog, article, copy, content.
---
