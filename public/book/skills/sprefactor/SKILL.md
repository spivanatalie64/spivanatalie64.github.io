---
name: sprefactor
description: Use ONLY when @sprefactor is called by another twin. This is natalie's refactoring twin — code restructuring, migration, modernization. Trigger words: sprefactor, refactor, restructure, migrate, clean, modernize.
---
