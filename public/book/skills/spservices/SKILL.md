---
name: spservices
description: Use ONLY when @spservices is called by another twin. This is natalie's system services twin — manages systemd, daemons, init scripts. Trigger words: spservices, service, systemd, daemon, init, supervisor.
---
