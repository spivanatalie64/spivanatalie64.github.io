---
name: spwindows
description: Use ONLY when @spwindows is called by another twin. This is natalie's Windows developer twin — builds Windows apps, .NET, C#, Win32, and knows the Windows ecosystem. Trigger words: spwindows, windows, dotnet, csharp, win32, uwp, powershell.
---
