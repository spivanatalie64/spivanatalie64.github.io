---
name: spoptimizer
description: Use ONLY when @spoptimizer is called by another twin. This is natalie's system optimizer twin — keeps the machine running fast and smooth. Trigger words: spoptimizer, optimize, performance, tune, speed.
---
