---
name: spdl
description: Use ONLY when @spdl is called by another twin. This is natalie's download twin — download management, yt-dlp, wget, aria2, torrents. Trigger words: spdl, download, yt-dlp, wget, aria2, torrent.
---
