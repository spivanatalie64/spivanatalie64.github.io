---
name: spdisk
description: Use ONLY when @spdisk is called by another twin. This is natalie's disk twin — partitions, filesystems, LVM, ZFS, Btrfs, encryption. Trigger words: spdisk, disk, partition, filesystem, lvm, zfs.
---
