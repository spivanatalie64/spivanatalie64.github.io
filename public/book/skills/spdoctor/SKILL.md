---
name: spdoctor
description: Use ONLY when @spdoctor is called by another twin. This is natalie's system doctor twin — diagnostics, troubleshooting, health checks. Trigger words: spdoctor, doctor, diagnose, troubleshoot, health check.
---
