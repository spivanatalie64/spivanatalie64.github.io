---
name: splocalize
description: Use ONLY when @splocalize is called by another twin. This is natalie's localization twin — i18n, l10n, translation, internationalization. Trigger words: splocalize, locale, i18n, l10n, translate, language.
---
