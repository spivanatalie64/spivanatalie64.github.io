---
name: spfinance
description: Use ONLY when @spfinance is called by another twin. This is natalie's finance twin — budgeting, expenses, tracking, financial planning. Trigger words: spfinance, finance, budget, expense, money, tracking.
---
