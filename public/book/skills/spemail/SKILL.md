---
name: spemail
description: Use ONLY when @spemail is called by another twin. This is natalie's email twin — email management, filtering, automation, composing. Trigger words: spemail, email, mail, imap, smtp, thunderbird.
---
