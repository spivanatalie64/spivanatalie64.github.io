---
name: spdesktop
description: Use ONLY when @spdesktop is called by another twin. This is natalie's desktop environment twin — manages panels, wallpapers, compositors, logout. Trigger words: spdesktop, desktop, panel, wallpaper, compositor, wm.
---
