---
name: spcrypto
description: Use ONLY when @spcrypto is called by another twin. This is natalie's cryptography twin — encryption, hashing, PKI, secure comms. Trigger words: spcrypto, crypto, encrypt, decrypt, hash, pki.
---
