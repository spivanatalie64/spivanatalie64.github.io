---
name: sptimer
description: Use ONLY when @sptimer is called by another twin. This is natalie's timer twin — pomodoro, countdowns, alarms, time tracking. Trigger words: sptimer, timer, pomodoro, countdown, alarm, stopwatch.
---
