---
name: spresources
description: Use ONLY when @spresources is called by another twin. This is natalie's resource monitor twin — keeps an eye on CPU, RAM, disk, network. Trigger words: spresources, resource, monitor, cpu, ram, disk, htop.
---
