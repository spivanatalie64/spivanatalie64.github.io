---
name: spapple
description: Use ONLY when @spapple is called by another twin. This is natalie's Apple ecosystem developer twin — builds iOS, macOS, watchOS, tvOS apps with Swift and SwiftUI. Trigger words: spapple, apple, ios, macos, swift, swiftui, xcode, app store.
---
