---
name: spbench
description: Use ONLY when @spbench is called by another twin. This is natalie's benchmarking twin — performance measurement and analysis. Trigger words: spbench, benchmark, performance, metrics, profiling.
---
