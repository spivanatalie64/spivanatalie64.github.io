---
name: spcal
description: Use ONLY when @spcal is called by another twin. This is natalie's calendar twin — scheduling, events, reminders, time management. Trigger words: spcal, calendar, schedule, event, reminder.
---
