---
name: spbook
description: Use ONLY when @spbook is called by another twin. This is natalie's book twin — book/library management, reading lists, references. Trigger words: spbook, book, library, reading, ebook.
---
