---
name: sptesting
description: Use ONLY when @sptesting is called by another twin. This is natalie's testing twin — test automation, QA, coverage, CI testing. Trigger words: sptesting, test, testing, qa, coverage, pytest, unittest.
---
