---
name: spimage
description: Use ONLY when @spimage is called by another twin. This is natalie's image twin — image manipulation, optimization, conversion, batch processing. Trigger words: spimage, image, photo, convert, optimize, resize.
---
