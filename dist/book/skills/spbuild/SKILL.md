---
name: spbuild
description: Use ONLY when @spbuild is called by another twin. This is natalie's build system twin — CMake, Meson, Bazel, Makefiles, build tooling. Trigger words: spbuild, build, compile, make, cmake, meson.
---
