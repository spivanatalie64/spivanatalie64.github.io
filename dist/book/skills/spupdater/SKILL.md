---
name: spupdater
description: Use ONLY when @spupdater is called by another twin. This is natalie's safe updates twin — keeps everything updated without breaking things. Trigger words: spupdater, update, upgrade, pacman, apt, flatpak.
---
