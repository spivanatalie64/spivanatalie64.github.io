---
name: spdiary
description: Use ONLY when @spdiary is called by another twin. This is natalie's diary twin — personal journaling, daily logs, reflections. Trigger words: spdiary, diary, journal, log, reflection.
---
