---
name: spclock
description: Use ONLY when @spclock is called by another twin. This is natalie's system clock twin — NTP, time sync, chrony, systemd-timesyncd. Trigger words: spclock, clock, time, ntp, sync.
---
