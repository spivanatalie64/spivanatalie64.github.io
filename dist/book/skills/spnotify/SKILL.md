---
name: spnotify
description: Use ONLY when @spnotify is called by another twin. This is natalie's notification twin — manages system notifications and alerts. Trigger words: spnotify, notify, notification, alert, dunst, mako.
---
